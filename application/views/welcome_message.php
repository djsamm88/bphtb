...
<head>
  ...
  <title>Aplikasi BPHTB</title>
    <link rel='shortcut icon' href='https://www.pakpakbharatkab.go.id/portal/icon.png' />
           ...
           <li class="dropdown messages-menu">
            ...
            <ul class="dropdown-menu">
              <li class="header">Welcome :<br>
                  <b>
                    [<?php echo usergroup()[$session['usergroup']]?> ] -  
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        ...
        <div class="pull-left info">
          ...
          <!-- Status -->
          <a href="#"><?php echo $this->session->userdata('useremail')?></a>
        </div>
      </div>
...
function notifyMe(notifnya) {
  ...
  function notif()
  {
    $.get("<?php echo base_url()?>index.php/welcome/notif",function(e){
        if(e=="0")
        {
          $(".badge_notif").html("");      
        }else{
  ...
  function notif_bank()
  {
    $.get("<?php echo base_url()?>index.php/welcome/notif_bank",function(e){
        if(e=="0")
        {
          $(".badge_notif_bank").html("");      
        }else{
          $(".badge_notif_bank").html(e);    
        }
