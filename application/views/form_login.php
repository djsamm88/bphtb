	...
	<div class="alert alert-warning text-center">
		...
		<h2><?php echo $title?> Administrator</h2>
			...
			<form id="form_login_test" style="margin:0 auto;">
					<table id="form_login">
						<tr>
							<td>Email</td> <td> <input type="email" name="useremail" placeholder="Email" class="form-control" required></td>
						</tr>
						<tr>
							<td>Password</td> <td> <input type="password" name="userpassword"  class="form-control" placeholder="Password" required></td>
						</tr>
						<tr>
							<td>
...
<footer class="footer">
      <div class="container">
        <p class="text-muted">Copyright 2020 Diskominfo</p>
      </div>
</footer>
